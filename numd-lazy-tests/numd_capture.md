...
│                                               │ erlinks to the temp table                                                │
│ cy follow                                     │ Create a cyberlink according to semantic construction of following a neu │
│                                               │ ron                                                                      │
...
│                                               │ berlinks table                                                           │
│ cy links-pin-columns                          │ Pin values from column 'text_from' and 'text_to' to an IPFS node and fil │
│                                               │ l according columns with their CIDs                                      │
...
│ cy graph-download-missing-particles           │ download particles missing from local cache for followed neurons or the  │
│                                               │ whole graph                                                              │
...
│ cy particles-keep-only-first-neuron           │ In the piped in particles df leave only particles appeared for the first │
│                                               │  time                                                                    │
...
│ cy graph-add-metadata                         │ Add content_s and neuron's nicknames columns to piped in or the whole gr │
│                                               │ aph df                                                                   │
...
│ cy cid-read-or-download                       │ Read a CID from the cache, and if the CID is absent - add it into the qu │
│                                               │ eue                                                                      │
...
│ cy watch-search-folder                        │ Watch the queue folder, and if there are updates, request files to downl │
│                                               │ oad                                                                      │
│ cy queue-cids-download                        │ Check the queue for the new CIDs, and if there are any, safely download  │
│                                               │ the text ones                                                            │
...
│ cy validator-generate-persistent-peers-string │ Dump the peers connected to the given node to the comma-separated 'persi │
│                                               │ stent_peers' list                                                        │
